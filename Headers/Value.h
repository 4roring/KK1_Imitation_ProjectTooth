...
// 이미지 사이즈들의 상수
constexpr int COMMANDER_CX = 72;
constexpr int COMMANDER_CY = 72;
constexpr int FARM_CX = 80;
constexpr int FARM_CY = 54;
constexpr int WINDMILL_CX = 140;
constexpr int WINDMILL_CY = 140;
...
constexpr int COLLTILEX = 49;
constexpr int COLLTILEY = 126;
