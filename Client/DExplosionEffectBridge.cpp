...
DExplosionEffectBridge::DExplosionEffectBridge()
{
}
...
HRESULT DExplosionEffectBridge::Initialize()
{
...
OBJSTATE DExplosionEffectBridge::Update(float deltaTime)
{
	FrameMove(deltaTime);
...
void DExplosionEffectBridge::LateUpdate()
{
	UpdateRect();
}

void DExplosionEffectBridge::Render()
{
	Vector3 vScroll = ViewMgr->GetScroll();

	D3DXMATRIX matScale, matTrans;

	D3DXMatrixScaling(&matScale, fScreenZoom * m_fSize, fScreenZoom * m_fSize, 1.f);
...
void DExplosionEffectBridge::Release()
{
}

void DExplosionEffectBridge::FrameMove(float deltaTime)
{
...
void DExplosionEffectBridge::UpdateRect()
{
